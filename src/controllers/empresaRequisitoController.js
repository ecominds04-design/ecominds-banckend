import { EmpresaRequisito, Empresa, RequisitoLegal, User, EnteRegulador } from '../models/index.js';
...
const update = async (req, res, next) => {
  try {
    ...
    ['responsableId', 'observaciones'].forEach((c) => { if (req.body[c] !== undefined) asignacion[c] = req.body[c]; });
