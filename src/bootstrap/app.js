...
import { doubleCsrfProtection, csrfErrorHandler, generateCsrfToken } from '../shared/security/csrf.js';
import { notFound, errorHandler } from '../shared/http/errors/error-handler.js';
import logger from '../shared/observability/logger.js';
import routes from './routes.js';
import renderApiLandingPage from './api-landing-page.js';
...
app.use(limiter);
app.use('/assets', express.static(path.join(__dirname, '../shared/infrastructure/email/assets')));

app.get('/', renderApiLandingPage);
app.get('/api', renderApiLandingPage);
