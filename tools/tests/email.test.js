...
} from '../../src/shared/infrastructure/email/emailService.js';

import {
  sendVerificationEmail,
  sendResetPasswordEmail,
} from '../../src/modules/identidad/application/emailService.js';

import { runDocumentosVencimientoJob } from '../../src/modules/documentos/jobs/documentosVencimientoJob.js';
import { runAuditoriaHoyJob } from '../../src/modules/auditorias/jobs/auditoriaHoyJob.js';
import { notificarDocumentoCargado } from '../../src/modules/documentos/application/documentoService.js';
import { notificarAuditoriaFinalizada } from '../../src/modules/auditorias/application/auditoriaService.js';
...
try {
  ...
  // 5. Notificación de documento cargado (vía servicio de aplicación)
  ...
  // 6. Notificación de auditoría finalizada (vía servicio de aplicación)
